...
export interface Database {
  public: {
    Tables: {
      ...
      acquisition_scan_audit_logs: {
        Row: Database['public']['Tables']['scan_audit_log']['Row']
        Insert: Database['public']['Tables']['scan_audit_log']['Insert']
        Update: Database['public']['Tables']['scan_audit_log']['Update']
      }
      acquisition_scan_market_intelligence: {
        Row: Database['public']['Tables']['market_intelligence']['Row']
        Insert: Database['public']['Tables']['market_intelligence']['Insert']
        Update: Database['public']['Tables']['market_intelligence']['Update']
      }
      acquisition_scan_reports: {
        Row: Database['public']['Tables']['scan_reports']['Row']
        Insert: Database['public']['Tables']['scan_reports']['Insert']
        Update: Database['public']['Tables']['scan_reports']['Update']
      }
    }
    Views: {
      [_ in never]: never
