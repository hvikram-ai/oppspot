-- ChatSpot™ - Conversational AI Interface
-- Created: 2025-10-02
...
CREATE TABLE IF NOT EXISTS chat_conversations (
  ...
  -- Indexes
  INDEX idx_chat_conversations_org_id ON chat_conversations(org_id),
  INDEX idx_chat_conversations_user_id ON chat_conversations(user_id),
  INDEX idx_chat_conversations_active ON chat_conversations(is_active) WHERE is_active = true
);
...
CREATE TABLE IF NOT EXISTS chat_messages (
  ...
  -- Indexes
  INDEX idx_chat_messages_conversation ON chat_messages(conversation_id),
